...
class Null_Calendar {
    ...
    public function initialize($config = array()) {
        ...
        if ($this->show_next_prev === TRUE && empty($this->next_prev_url)) {
            $this->next_prev_url = $this->Null->config->site_url($this->Null->router->class . '/' . $this->Null->router->method);
        }
    ...
    public function get_month_name($month) {
        ...
        return ($this->Null->lang->line($month_names[$month]) === FALSE) ? ucfirst(substr($month_names[$month], 4)) : $this->Null->lang->line($month_names[$month]);
    }
    ...
    public function get_day_names($day_type = '') {
        ...
        for ($i = 0, $c = count($day_names); $i < $c; $i++) {
            $days[] = ($this->Null->lang->line('cal_' . $day_names[$i]) === FALSE) ? ucfirst($day_names[$i]) : $this->Null->lang->line('cal_' . $day_names[$i]);
        }
