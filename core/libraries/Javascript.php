...
class Null_Javascript {
    ...
    public function __construct($params = array()) {
        ...
        $this->Null->load->library('Javascript/' . $js_library_driver, array('autoload' => $autoload));
        // make js to refer to current library
        $this->js = & $this->Null->$js_library_driver;
    ...
    public function external($external_file = '', $relative = FALSE) {
        ...
        } elseif ($this->Null->config->item('javascript_location') !== '') {
            $this->_javascript_location = $this->Null->config->item('javascript_location');
        }
        ...
        if ($relative === TRUE OR strpos($external_file, 'http://') === 0 OR strpos($external_file, 'https://') === 0) {
            ...
            $str = $this->_open_script($this->Null->config->slash_item('base_url') . $this->_javascript_location . $external_file);
        }
    ...
    protected function _open_script($src = '') {
        return '<script type="text/javascript" charset="' . strtolower($this->Null->config->item('charset')) . '"'
                . ($src === '' ? '>' : ' src="' . $src . '">');
    }
