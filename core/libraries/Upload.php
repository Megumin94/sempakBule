...
class Null_Upload {
    ...
    public function do_upload($field = 'userfile') {
        ...
        $this->file_name = $this->_Null->security->sanitize_filename($this->file_name);
    ...
    public function do_xss_clean() {
        ...
        return $this->_Null->security->xss_clean($data, TRUE);
    }

    // --------------------------------------------------------------------

    public function set_error($msg, $log_level = 'error') {
        $this->_Null->lang->load('upload');

        is_array($msg) OR $msg = array($msg);
        foreach ($msg as $val) {
            $msg = ($this->_Null->lang->line($val) === FALSE) ? $val : $this->_Null->lang->line($val);
            $this->error_msg[] = $msg;
