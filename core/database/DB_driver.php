...
abstract class Null_DB_driver {
     ...
     * Queries list
     *
     * @see	Null_DB_driver::$save_queries
     * @var	string[]
     */
     ...
     * COUNT string
     *
     * @used-by	Null_DB_driver::count_all()
     * @used-by	Null_DB_query_builder::count_all_results()
     *
     * @var	string
     */
    ...
    public function load_rdriver() {
        $driver = 'Null_DB_' . $this->dbdriver . '_result';
    ...
    protected function _cache_init() {
        if (!class_exists('Null_DB_Cache', FALSE)) {
            require_once(BASEPATH . 'database/DB_cache.php');
        } elseif (is_object($this->CACHE)) {
            return TRUE;
        }

        $this->CACHE = new Null_DB_Cache($this); // pass db object to support multiple db connections and returned db objects
        return TRUE;
    }
